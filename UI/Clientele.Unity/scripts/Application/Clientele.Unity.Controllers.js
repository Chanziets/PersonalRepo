...
angular.module('Clientele.Unity.Controllers', ['Clientele.AuthControllers'])
    ...
    .controller("AddressEditModalInstanceCtrl", ['$scope', '$modalInstance', 'addressValidationApiFactory', 'address', function ($scope, $modalInstance, addressValidationApiFactory, address) {
    ...
    .controller("UnityBankDetailViewController", ['$scope', '$modal', function ($scope, $modal) {
        ...
        $scope.updateBankDetails = function () {
            ...
            modalInstance.result.then(function (bankAcc) {
                $scope.accountType = bankAcc.accountType;
                $scope.accountName = bankAcc.accountName;
                $scope.accountNumber = bankAcc.accountNumber;
                $scope.bankName = bankAcc.bankName;
                $scope.branchCode = bankAcc.branchCode;
                $scope.branchCodeName = bankAcc.branchCodeName;
            });
        };
    }])
