...
(function () {
    angular.module('Clientele.WorkFlowServices.Tasks.Services', [])
            ...
            function (tasksApplicationRepository, sharedTaskData, eventBroadcastingService, ajaxJsonService, workflowServicesManagementApiService, modalService, $filter,$route) {
                ...
                return {
                    ...
                    viewStatusHistory: function (taskId) {
                        ajaxJsonService.Get(workflowServicesManagementApiService.getWorkflowApiUrl() + 'StatusHistory/' + taskId).then(function (result) {
        ...
        .service('Clientele.WorkFlowServices.Tasks.Services.ApplicationRepository', function ($location) {
            ...
            return {
                ...
                getRoute: function (applicationId, queue) {
                    ...
                    var application = Enumerable.From(applicationConfigurations).FirstOrDefault(function (x) {
                        return x.ApplicationId.toLowerCase() == applicationId.ApplicationName.toLowerCase();
                    });
        ...
        .service('Clientele.WorkFlowServices.Tasks.ModalService', ['$modal', 'eventBroadcastingService', function ($modal, eventBroadcastingService) {
            ...
            return {
                showGenericModal: function (header, body, backdropStatic) {
                    if (angular.isUndefined(backdropStatic) || backdropStatic == null) {
                        backdropStatic = 'true';
                    }
                    return $modal.open({
                        templateUrl: sourceUrl + '/Application/Common/Templates/genericModal.tpl.html',
                        controller: 'Clientele.ApplicationFormsCapture.GenericModalController',
                        size: 'lg',
                ...
                showGenericYesNoModal: function (header, body, action) {

                    var modalInstance = $modal.open({
                        templateUrl: sourceUrl + '/Application/Common/Templates/genericYesNoModal.tpl.html',
                        controller: 'Clientele.ApplicationFormsCapture.GenericYesNoModalController',
                        size: 'lg',
                        backdrop: 'static',
                        resolve: {
                            model: function () {
                ...
                showDiscardChangesModal: function (header, body) {
                    ...
                    modalInstance.result.then(function (value) {
                        eventBroadcastingService.broadcastEvent('Clientele.Capture.DiscardChanges', value);
                    }, null);
                },
                showCloseModal: function (resultAction, model) {

                    var modalInstance = $modal.open({
                        templateUrl: sourceUrl + '/Application/Common/Templates/CloseTaskModal.tpl.html',
                        controller: 'Clientele.ApplicationFormsCapture.CloseTaskModalController',
                        size: 'lg',
                        backdrop: 'static',
                        resolve: {
                            model: function () {
                ...
                showMandatoryCommentModalApplicationFormFraudWarning: function (resultAction, model) {

                    var modalInstance = $modal.open({
                        templateUrl: sourceUrl + '/Application/Common/Templates/ComplianceCommentFormModal.tpl.html',
                        controller: 'Clientele.ApplicationFormsCapture.ComplianceCommentFormModalController',
                        size: 'lg',
                        backdrop: 'static',
                        resolve: {
                            model: function () {
                    ...
                    modalInstance.result.then(function (result) {
                        resultAction({ comment: result.comment, actionReasonId: result.actionReasonId });
                    }, null);
                },
                showCloseApplicationFormModal: function (resultAction, model) {

                    var modalInstance = $modal.open({
                        templateUrl: sourceUrl + '/Application/Common/Templates/CloseApplicationFormModal.tpl.html',
                        controller: 'Clientele.ApplicationFormsCapture.CloseApplicationFormModalController',
                        size: 'lg',
                        backdrop: 'static',
                        resolve: {
                            model: function () {
                ...
                showApplicationFormComments: function (data) {

                    $modal.open({
                        templateUrl: sourceUrl + '/Application/Common/Templates/captureApplicationFormCommentModal.tpl.html',
                        controller: 'Clientele.ApplicationFormsCapture.ApplicationFormCommentModalController',
                        size: 'lg',
                        windowClass: 'unity-modal-lg',
                        resolve: {
                            model: function () {
                                return { Header: "Comments", Comments: data };
                            }
                        }
                    });
                },
