...
angular.module('Clientele.RecordStore', ['Clientele.RecordStore.Routes', 'Clientele.RecordStore.Services'])
    .run(function (unityApplicationRepository, cssInjector) {
        ...
        var configuration = { Id: recordStoreGuid, searchUrl: "/recordstore/advancedSearch/", applicationName: "Clientele Record Store", icon: "/content/images/recordStoreIcon.jpg", IdentityPrefix: "Clientele.RecordStore" };
