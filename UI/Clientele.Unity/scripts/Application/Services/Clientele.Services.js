angular.module('Clientele.Services', ['ngResource'])
    ...
    .service('notificationService', function ($dialogs) {
        ...
        var consumeConfirm = function () {
            ...
            window.confirm = function (mess, acceptAction, declineAction) {
                return confirm(mess, acceptAction, declineAction);
            };
        ...
        var confirm = function (message, acceptAction, declineAction) {
            dlg = $dialogs.confirm(message);
            dlg.result.then(
                function () {
                    acceptAction();
                },
    ...
    .factory('uiLoader', function ($q) {
        ...
        return {
            ...
            UseLoaderWithCustomMessage: function (scope, action, successAction, customMessage) {
                useWithLoader(scope, action, successAction);
